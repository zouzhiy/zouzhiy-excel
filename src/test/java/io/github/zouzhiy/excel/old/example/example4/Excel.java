 ...
 */
package io.github.zouzhiy.excel.old.example.example4;
...
import io.github.zouzhiy.excel.old.example.example4.handler.ItemListNumberSplitHandler;
import io.github.zouzhiy.excel.old.example.example4.handler.ItemNumberHandler;
import io.github.zouzhiy.excel.old.example.example4.matedata.Demo;
...
public class Excel {
    ...
    private final ZouzhiyExcelFactory zouzhiyExcelFactory = ZouzhiyExcelFactoryBuilder.builder()
            .register(new ItemListNumberSplitHandler())
            .register(new ItemNumberHandler())
            .build();
