 ...
 */
package io.github.zouzhiy.excel.old.example.example8;
...
import io.github.zouzhiy.excel.old.example.example8.handler.ItemListJoinHandler;
import io.github.zouzhiy.excel.old.example.example8.handler.ItemStringHandler;
import io.github.zouzhiy.excel.old.example.example8.matedata.Demo;
...
public class Excel {
    ...
    private final ZouzhiyExcelFactory zouzhiyExcelFactory = ZouzhiyExcelFactoryBuilder.builder()
            .register(new ItemListJoinHandler())
            .register(new ItemStringHandler())
            .build();
