...
class BigDecimalNumberHandlerTest extends CellHandlerTest {

    private final BigDecimalNumberHandler cellHandler = new BigDecimalNumberHandler();
    ...
    void write() {
        ...
        BigDecimal value = random.nextBoolean() ? null : BigDecimal.valueOf(random.nextInt(1));
