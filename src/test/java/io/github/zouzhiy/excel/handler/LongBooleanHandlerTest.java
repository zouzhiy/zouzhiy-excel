...
class LongBooleanHandlerTest extends CellHandlerTest {

    private final LongBooleanHandler cellHandler = new LongBooleanHandler();
    ...
    @RepeatedTest(5)
    void read() {
        Long value = (long) random.nextInt(2);
    ...
    @RepeatedTest(10)
    void write() {
        Long value = random.nextBoolean() ? null : (long) random.nextInt(2);
        ...
        if (value == null) {
            ...
            Mockito.verify(cell).setCellValue(value.compareTo(1L) == 0);
        }
