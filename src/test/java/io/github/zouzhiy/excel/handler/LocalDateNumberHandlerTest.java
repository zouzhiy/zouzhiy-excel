...
class LocalDateNumberHandlerTest extends CellHandlerTest {

    private final LocalDateNumberHandler cellHandler = new LocalDateNumberHandler();
    ...
    void write() {
        ...
        if (value == null) {
            ...
            Mockito.verify(cell).setCellValue(DateUtil.getExcelDate(value));
        }
