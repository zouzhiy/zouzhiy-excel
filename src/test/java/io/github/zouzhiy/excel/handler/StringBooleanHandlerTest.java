...
class StringBooleanHandlerTest extends CellHandlerTest {

    private final StringBooleanHandler cellHandler = new StringBooleanHandler();
    ...
    @RepeatedTest(5)
    void read() {
        String value = String.valueOf(random.nextBoolean());
    ...
    @RepeatedTest(10)
    void write() {
        String value = random.nextBoolean() ? null : String.valueOf(random.nextBoolean());
        ...
        if (value == null) {
            ...
            Mockito.verify(cell).setCellValue(Boolean.parseBoolean(value));
        }
