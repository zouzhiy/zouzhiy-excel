...
class BooleanNumberHandlerTest extends CellHandlerTest {

    private final BooleanNumberHandler cellHandler = new BooleanNumberHandler();
    ...
    void write() {
        ...
        if (value == null) {
            ...
            Mockito.verify(cell).setCellValue(value ? BigDecimal.ONE.doubleValue() : BigDecimal.ZERO.doubleValue());
        }
