...
class HeadStringHandlerTest extends CellHandlerTest {

    private final HeadStringHandler cellHandler = new HeadStringHandler();
    ...
    void read() {
        ...
        String value = "tt" + random.nextDouble();
    ...
    void writeNull() {
        ...
        Mockito.when(sheetContext.getHeadCellStyle(excelFieldConfig)).thenReturn(cellStyle);
