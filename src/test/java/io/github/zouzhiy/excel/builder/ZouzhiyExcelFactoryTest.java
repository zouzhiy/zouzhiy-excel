...
class ZouzhiyExcelFactoryTest {
    ...
    void write() {
        ...
        WorkbookParameter writeWorkbookParameter = this.getWriteWorkbookParameter();
        ...
        WorkbookParameter writeWorkbookParameter2 = this.getWriteWorkbookParameter();
    ...
    private WorkbookParameter getWriteWorkbookParameter() {
