 ...
 */
package io.github.zouzhiy.excel.example.example2;
...
import io.github.zouzhiy.excel.example.example2.handler.ItemListStringHandler;
import io.github.zouzhiy.excel.example.example2.handler.ItemStringHandler;
import io.github.zouzhiy.excel.example.example2.matedata.Demo;
...
public class Excel {
    ...
    private final ZouzhiyExcelFactory zouzhiyExcelFactory = ZouzhiyExcelFactoryBuilder.builder()
            ...
            .register(new ItemListStringHandler())
            .build();
