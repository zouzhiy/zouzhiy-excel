 ...
 */
package io.github.zouzhiy.excel.example.example3;
...
import io.github.zouzhiy.excel.example.example3.handler.ItemStringHandler;
import io.github.zouzhiy.excel.example.example3.matedata.Demo;
...
public class Excel {
    ...
    private final ZouzhiyExcelFactory zouzhiyExcelFactory = ZouzhiyExcelFactoryBuilder.builder()
            ...
            .register(new ItemListStringSplitHandler())
            .build();
