 ...
 * @since 2022/7/10
 */
public abstract class AbstractLongCellHandler extends AbstractCellHandler<Long> {

    @Override
    protected final Long getCellValue(SheetContext sheetContext, ExcelFieldConfig excelFieldConfig, CellResult firstCellResult) {
