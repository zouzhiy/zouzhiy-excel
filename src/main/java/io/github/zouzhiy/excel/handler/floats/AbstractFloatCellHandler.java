 ...
 * @since 2022/7/10
 */
public abstract class AbstractFloatCellHandler extends AbstractCellHandler<Float> {

    @Override
    protected final Float getCellValue(SheetContext sheetContext, ExcelFieldConfig excelFieldConfig, CellResult firstCellResult) {
