 ...
 * @since 2022/7/10
 */
public abstract class AbstractDoubleCellHandler extends AbstractCellHandler<Double> {

    @Override
    protected final Double getCellValue(SheetContext sheetContext, ExcelFieldConfig excelFieldConfig, CellResult firstCellResult) {
