...
import io.github.zouzhiy.excel.ibatis.reflection.invoker.*;
import io.github.zouzhiy.excel.ibatis.reflection.property.PropertyNamer;
...
public class Reflector {
    ...
    public Constructor<?> getDefaultConstructor() {
        if (defaultConstructor != null) {
            ...
            throw new ExcelException("There is no default constructor for " + type);
        }
    }
    ...
    public Invoker getSetInvoker(String propertyName) {
        ...
        if (method == null) {
            throw new ExcelException("There is no setter for property named '" + propertyName + "' in '" + type + "'");
        }
        return method;
    }
    ...
    public Invoker getGetInvoker(String propertyName) {
        ...
        if (method == null) {
            throw new ExcelException("There is no getter for property named '" + propertyName + "' in '" + type + "'");
        }
        return method;
    }
